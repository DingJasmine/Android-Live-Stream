...
///oem/etc/theme/icons/dynamic_icon/com.android.BBKClock/res/drawable-sw360dp-xhdpi/clock_hour.png
/**
 * 显示多路摄像头
 */
public class MainActivity extends BaseActivity implements CameraDialog.CameraDialogParent {
    ...
    // origin camera
    private AspectRatioTextureView mTextureView; //改2
    //private CameraGLSurfaceView mTextureView;
    ...
    private AspectRatioTextureView MonTextureView; //改2
    //private CameraGLSurfaceView MonTextureView;
...
//filter
//private AspectRatioTextureView mCameraSurfaceView;
...
//    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        result_Mon_surface();
        //filter
        //mCameraSurfaceView = (AspectRatioTextureView) findViewById(R.id.camera_view_Mon);//改
//        mTextureView.setEGLContextClientVersion(2);
//        mTextureView.setRenderer(new ApplicationRender());
...
//    };
    ...
    private void result_Mon_surface(){
        ...
        //filter
        findViewById(R.id.filter2).setOnClickListener(v -> {
            MonTextureView.setFrameRenderer(2);
        });
        findViewById(R.id.filter1).setOnClickListener(v -> {
            MonTextureView.setFrameRenderer(1);
        });

        findViewById(R.id.filter3).setOnClickListener(v -> {
            MonTextureView.setFrameRenderer(3);
        });
        findViewById(R.id.filter4).setOnClickListener(v -> {
            MonTextureView.setFrameRenderer(4);
        });
